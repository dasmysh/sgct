...
void sgct_core::SpoutOutputProjection::initTextures() {
    ...
    for (unsigned int & i : spoutTexture) {
#ifdef SGCT_HAS_SPOUT
        handle[i] = GetSpout();
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, mTextureInternalFormat, mCubemapResolution, mCubemapResolution, 0, mTextureFormat, mTextureType, nullptr);
    }
